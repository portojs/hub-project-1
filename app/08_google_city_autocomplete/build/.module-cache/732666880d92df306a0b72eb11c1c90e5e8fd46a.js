...
(function() {
  ...
  var UncontrolledComponent = React.createClass({displayName: "UncontrolledComponent",
    ...
    render: function() {
      return (React.createElement("div", null, 
                React.createElement("input", {ref: "first", type: "text", defaultValue: "init", onChange: this.handleChange}), 
                React.createElement("input", {ref: "second", type: "text"}), 
                React.createElement("button", {onClick: this.handleAdd}, "Add"), 
                React.createElement("input", {ref: "result", type: "text"})
              ));
    },
    componentDidMount: function() {
